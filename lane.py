    ...
    def setupObstacles(self):
        ...
        if self.lane_type == "street":
            ...
            if self.direction == "left":
                left = middle = right = f"assets/{self.lane_type}/{self.direction}/turtle.png"
            elif self.direction == "right":
                left, middle, right = (
                    f"assets/{self.lane_type}/{self.direction}/left.png",
                    f"assets/{self.lane_type}/{self.direction}/middle.png",
                    f"assets/{self.lane_type}/{self.direction}/right.png"
                )
